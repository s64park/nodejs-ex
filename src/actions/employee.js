...
export function getEmployees() {
    return (dispatch) => {
        axios.get(`/api/admin`,  {headers: { 'x-access-token': localStorage.getItem('token')}}) // temporarily use admin id to authenticate
            .then((response) => {
...
export function getEmployee(employeeId) {
    return (dispatch) => {
        axios.get(`/api/admin/${employeeId}`, {headers: { 'x-access-token': localStorage.getItem('token')}})
            .then((response) => {
...
export function addEmployee(employee) {
    return (dispatch) => {
        axios.post(`/api/admin`, {token: localStorage.getItem('token'), ...employee}) // pass new employee information through the body
            .then((response) => {
...
export function updateEmployee(employee, employeeId) {
    return (dispatch) => {
        axios.put(`/api/admin/${employeeId}`, {token: localStorage.getItem('token'), ...employee}) // pass update information of the employee
            .then((response) => {
...
export function removeEmployee(employeeId) {
    return (dispatch) => {
        axios.delete(`/api/admin/${employeeId}`,  {headers: { 'x-access-token': localStorage.getItem('token')}})
            .then((response) => {
