...
export function getFeedbacks(employeeId) {
    return (dispatch) => {
        axios.get(`/api/admin/feedback/${employeeId}`, {headers: { 'x-access-token': localStorage.getItem('token')}})
            .then((response) => {
...
export function assignFeedback(assignedEmployeeId, employeeId, employeeInfo) {
    return (dispatch) => {
        axios.put(`/api/admin/feedback/${assignedEmployeeId}/${employeeId}`, {token: localStorage.getItem('token'), ...employeeInfo})
            .then((response) => {
...
export function unassignedFeedback(unassignedEmployeeId, employeeId) {
    return (dispatch) => {
        axios.delete(`/api/admin/feedback/${unassignedEmployeeId}/${employeeId}`, {headers: { 'x-access-token': localStorage.getItem('token')}})
            .then((response) => {
...
export function getEmployeeFeedbacks(employeeId) {
    return (dispatch) => {
        axios.get(`/api/employee/${employeeId}`, {headers: { 'x-access-token': localStorage.getItem('token')}})
            .then((response) => {
...
export function submitFeedback(feedback, employeeId, feedbackId) {
    return (dispatch) => {
        ...
        axios.post(`/api/employee/${employeeId}/${feedbackId}`, {token: localStorage.getItem('token'), ...feedback})
            .then((response) => {
...
export function saveFeedback(feedback, employeeId, feedbackId) {
    return (dispatch) => {
        axios.put(`/api/employee/${employeeId}/${feedbackId}`, {token: localStorage.getItem('token'), ...feedback})
            .then((response) => {
