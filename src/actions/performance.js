...
export function getPerformance(employeeId, cb) {
    return (dispatch) => {
        axios.get(`/api/admin/performanceReview/${employeeId}`, {headers: { 'x-access-token': localStorage.getItem('token')}})
            .then((response) => {
...
export function updatePerformance(performance, employeeId) {
    return (dispatch) => {
        axios.put(`/api/admin/performanceReview/${employeeId}`, {token: localStorage.getItem('token'), ...performance})
            .then((response) => {
